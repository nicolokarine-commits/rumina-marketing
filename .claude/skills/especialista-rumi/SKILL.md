...
- Download de relatórios completos em PDF e xlsx direto no WhatsApp — ago/2025
- Geração de gráficos: curvas de lactação, dispersão, barras — mar/2026

### Lançamento de dados
- Protocolo de IATF: entrada de dados, lista de medicamentos, datas — set/2025
- Cadastro de novos animais — mar/2026
- Lançamentos financeiros: entradas e saídas — jan/2026

### Inteligência proativa
- Agentes pró-ativos: Rúmi envia alertas e análises sem o produtor perguntar — fev/2026
- Agente VoC (Voz do Campo): coleta feedback e sinais do produtor — fev/2026

### Onboarding e suporte
- Fluxo de boas-vindas para novos usuários — out/2025
- Respostas em linguagem natural sobre dados da fazenda

---

## Contexto de uso

**Quem usa:** produtor rural que já usa o Ideagri ou Rúmina Insights e quer acesso rápido pelo celular sem abrir o computador.

**Quando usa:** no campo, na ordenha, em reuniões com o técnico, quando precisa de um dado rápido.

**Onde aparece:** WhatsApp — o aplicativo que o produtor já usa e não precisa aprender.

**Por que importa:** elimina a barreira entre o produtor e os dados da fazenda. A informação que antes exigia computador + login + navegação está a uma mensagem de distância.
...
Ao recomendar criação de carrossel, especificar o gradiente Rúmi para a skill `/carrossel`.
